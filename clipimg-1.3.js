$.fn.clip = function (ops) {
    ...
    var main = {
                ...
                fileReader.onload = function (event) {
                    ...
                    if (options.clip) {
                        ...
                        $("#btnCancel").off().on("click", function () {
                            $("#clipImg").hide();
                            _self.parent().html('<input style="display:none;" type="file" id="' + _id + '" name="' + _id + '" />重新选择');
                            $("#clipImg").html("");
                            _self = $("#" + _id);
                            main.initEvent();
                        });
        ...
        init: function () {
            ...
            var ctx_X = ($canvas.width() - $img.width()) / 2,
                ctx_Y = ($canvas.height() - $img.height()) / 2;
